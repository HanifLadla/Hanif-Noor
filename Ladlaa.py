...
\033[1;41m\033[1;37m[⚡⚡\033[1;37mAuthor Name: Hanif Noor  ⚡⚡\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[⚡⚡\033[1;37mPhone Numbr: *********⚡⚡\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[⚡⚡\033[1;37m]\033[1;0m
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: Ladlaa
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;97mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCwZuI8xA8qSgdiLTK4dd8NA')
    else:
